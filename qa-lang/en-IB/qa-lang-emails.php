...
*/
	...
	return array(
		...
		'a_followed_body' => "Your answer on ^site_title has a new related idea by ^q_handle:\n\n^open^q_title^close\n\nYour answer was:\n\n^open^a_content^close\n\nClick below to answer the new idea:\n\n^url\n\nThank you,\n\n^site_title",
		'a_followed_subject' => 'Your ^site_title answer has a related idea',
		...
		'q_answered_body' => "Your idea on ^site_title has been answered by ^a_handle:\n\n^open^a_content^close\n\nYour idea was:\n\n^open^q_title^close\n\nIf you like this answer, you may select it as the best:\n\n^url\n\nThank you,\n\n^site_title",
		'q_answered_subject' => 'Your ^site_title idea was answered',
