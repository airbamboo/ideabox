...
*/
	...
	return array(
		...
		'default_sidebar' => "Welcome to ^, where you can submit ideas and receive answers from other members of the community.",
		'default_subject' => 'A message from ^',
		'default_suffix' => 'Q&A',
		'do_ask_check_qs' => 'Check for similar ideas when submitting:',
		...
		'max_rate_ip_qs' => 'Rate limit for submitting ideas:',
		...
		'notify_admin_q_post' => 'Email this address when a idea is submitted',
